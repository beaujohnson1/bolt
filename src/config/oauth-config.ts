  ...
  private getEnvVars(): Record<string, string> {
    ...
    if (typeof window !== 'undefined' && import.meta?.env) {
      return {
        ...
        EBAY_OAUTH_RU_NAME: import.meta.env.VITE_EBAY_OAUTH_RU_NAME || 'easyflip.ai-easyflip-easyfl-cnqajybp',
    ...
    if (typeof process !== 'undefined' && process.env) {
      return {
        ...
        EBAY_OAUTH_RU_NAME: process.env.EBAY_OAUTH_RU_NAME || 'easyflip.ai-easyflip-easyfl-cnqajybp',
        EBAY_OAUTH_REDIRECT_URI: process.env.EBAY_OAUTH_REDIRECT_URI || 'https://easyflip.ai/auth/ebay/callback',
    ...
    return {
      ...
      EBAY_OAUTH_RU_NAME: 'easyflip.ai-easyflip-easyfl-cnqajybp',
      EBAY_OAUTH_REDIRECT_URI: 'https://easyflip.ai/auth/ebay/callback',
