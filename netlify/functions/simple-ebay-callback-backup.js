            ...
            const successPageHtml = `
                ...
                <body>
                    ...
                    <script>
                        ...
                        // Auto-start token exchange on page load
                        if (document.readyState === 'loading') {
                            document.addEventListener('DOMContentLoaded', () => {
                                console.log('📄 DOM loaded, starting token exchange...');
                                setTimeout(exchangeTokens, 500);
                            });
                        } else {
                            console.log('📄 DOM already loaded, starting token exchange...');
                            setTimeout(exchangeTokens, 500);
                        }
                        
                        // Additional event listeners for debugging
                        window.addEventListener('beforeunload', () => {
                            console.log('🚪 Window is closing/navigating away');
                        });
                        ...
                        console.log('✅ OAuth callback script fully loaded and ready');
                    </script>
                </body>
                </html>
            `;
